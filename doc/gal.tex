...
Implementovaný algoritmus jsme převzali z \cite{demel}. Jeho základem je metoda zpětného navracení. Algoritmus lze upravit pro hledání nejpočetnější nebo nejdražší nezávislé množiny. Jeho složitost je \(O(??)\), kde \(n\) je počet uzlů grafu.

% TODO: jak to je s nasi slozitosti?
Tady bude algoritmus
...
\bibitem{demel}
  ...
  Praha: nakladatelství Academia, 2002.

\bibitem{robson}
  Robson, John Michael.
  "Algorithms for maximum independent sets."
  \emph{Journal of Algorithms} 7.3 (1986): 425-440

\bibitem{fomin}
  Fomin, Fedor V., Fabrizio Grandoni, and Dieter Kratsch.
  "Measure and conquer: a simple O (2 0.288 n) independent set algorithm."
  \emph{Proceedings of the seventeenth annual ACM-SIAM symposium on Discrete algorithm.}
   ACM, 2006.
